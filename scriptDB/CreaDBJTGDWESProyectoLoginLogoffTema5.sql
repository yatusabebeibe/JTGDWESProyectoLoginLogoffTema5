CREATE DATABASE IF NOT EXISTS DBJTGDWESProyectoLoginLogoffTema5;
...
CREATE USER IF NOT EXISTS 'userJTGDWESProyectoLoginLogoffTema5'@'%' IDENTIFIED BY 'paso';
GRANT ALL PRIVILEGES ON DBJTGDWESProyectoLoginLogoffTema5.* TO 'userJTGDWESProyectoLoginLogoffTema5'@'%';
FLUSH PRIVILEGES;